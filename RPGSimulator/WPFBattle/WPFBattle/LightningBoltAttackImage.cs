...
namespace WPFBattle
{
    class LightningBoltAttackImage : NormalAttack
    {
        private CharacterImage currentImage;
        //constructor creating SwordAttack with image
        public LightningBoltAttackImage(CharacterImage image)
        {
        ...
        public override void Attack(ICharacter attacker, ICharacter target)
        {
            ...
            Console.WriteLine("{0} shoots a lightning bolt at {1}!", attacker.Name, target.Name);
